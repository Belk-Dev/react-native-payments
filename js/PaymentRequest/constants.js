...
export const PAYMENT_METHOD_CHANGE_EVENT = "paymentmethodchange";
...
export const INTERNAL_PAYMENT_METHOD_CHANGE_EVENT = `${MODULE_SCOPING}:on${PAYMENT_METHOD_CHANGE_EVENT}`;
